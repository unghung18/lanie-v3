...
import { categoryProductPage, colorData } from '../../../../contants';
...
const Page = ({ searchParams }: { searchParams: { [key: string]: string | undefined } }) => {
    ...
    const size = searchParams.size ? searchParams.size : "";
    const color = searchParams.color ? searchParams.color : "";
    const sale = searchParams.sale ? searchParams.sale : "";
